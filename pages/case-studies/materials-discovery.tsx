	...
	return (
		<>
			...
			<Callout background='#161616' leftText='Case Study'>
				<CalloutHeading>
					Collaborative use of generative and foundation models for
					materials discovery
				</CalloutHeading>
				<CalloutBody>
					<p>
						Materials scientists are increasingly turning toward
						generative AI and foundation models to design new
						molecules to test against target properties. This
						requires the use of large chemical datasets, often
						containing proprietary IP, as well as the ability to
						rerun the computational steps of these experiments to
						reproduce or further refine results. The Discovery
						Platform provides a secure environment to access and use
						sensitive data, access to Kubernetes-based
						infrastructure for workload portability, scalability and
						tooling, and the ability to store and save workflows
						to repeat and reproduce runs. These capabilities make it
						easier for researchers without AI-expertise to make use
						of the new techniques that will shape their scientific
						domains.
					</p>
				</CalloutBody>
			</Callout>
          ...
          Learn how these early adopters use the Discovery Platform.
			...
			>
				<CalloutHeading>
					...
					Discovery Platform today and get access to new features as
					they roll out.
				</CalloutHeading>
				<CalloutBody>
